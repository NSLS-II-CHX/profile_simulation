...
manual_count_template =  """{{- start.plan_name }} ['{{ start.uid[:6] }}'] (scan num: {{ start.scan_id }}) (Simulation: {{start.Simulation}} )"""

 

count_template = """{{- start.plan_name}} :  {{start.plan_args.num}} ['{{ start.uid[:6] }}'] (scan num: {{ start.scan_id }}) (Simulation: {{start.Simulation}} )
...
LOGBOOKS = ['Simulation']  # list of logbook names to publish to
